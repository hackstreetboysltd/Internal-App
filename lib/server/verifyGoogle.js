...
import { realNowMs } from "@/lib/server/realTime";

// Prefer IPv4 and disable Happy Eyeballs (see instrumentation.node.js).
...
export async function verifyIdToken(idToken) {
  ...
  if (payload.exp && Number(payload.exp) * 1000 < realNowMs()) {
